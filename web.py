...
from inference.predict_single_freight_cost import predict_frieght_cost
from inference.predict_single_invoice_flag import predict_invoice_flag
...
if selected_model == "Freight Cost Prediction":
    ...
    **Objective:**  
    ...
    if submit_freight:
        ...
        prediction = predict_frieght_cost(input_data)['Predicted Frieght']
...
# -------------------------------------------------------
    ...
    **Objective:**  
    ...
    if submit_flag:
        ...
        flag_prediction = predict_invoice_flag(input_data)['invoice_flag']
